...
// React is loaded globally. Hooks like useState must be prefixed with `React.`.
// Child components, types, and services are also loaded globally before this script.
